...
const PDF = () =>{
  ...
  const fetchData = async () => {
    ...
    const getCardStyle = (index:any) => {
      if (index < 209) {
        return "./Parte_delante_3.png"
        
      } else if (index < 209 + 62) {
        return "./Parte_delante_2.png"
      } else {
        return "./Parte_delante.png"
          ...
          <View key={pageIndex*2} style={{justifyContent: "space-evenly", width: "100%vw", height:"100%vh", flexDirection: "column"}}>
...

            {
              Array.from({length: 3}).map(( _, rowIndex) =>{
                ...
                return (
                  <View key={rowIndex} style={{justifyContent: "space-evenly", flexDirection:"row", width: "100%vw"}}>
                    ...
                    {rowCards.map((card:any,cardIndex:any)=>{
                      ...
                      return(
                        ...
                        <View key={cardIndex} style={styles.section}>
                          ...
                          <Text key={cardIndex/3} style={getCardStyle2(globalIndex)}>{card}</Text>
                        </View>
